...
impl TestSqliteDatabase {
    ...
    pub fn create_test_sqlite(&self, table_name: &str) {
        let query = format!(
    ...
    pub fn fill_test_table(&self, table_name: &str, num_rows: usize) {
    ...
    pub fn get_all_rows(&self, table_name: &str) -> Vec<TestRow> {
