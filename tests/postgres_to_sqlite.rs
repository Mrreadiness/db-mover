...
fn in_table_not_found() {
    testcases::in_table_not_found(TestPostresDatabase::new(), TestSqliteDatabase::new());
}

#[test]
fn out_table_not_found() {
    testcases::out_table_not_found(TestPostresDatabase::new(), TestSqliteDatabase::new());
}

#[test]
fn out_table_is_not_empty() {
    testcases::out_table_is_not_empty(TestPostresDatabase::new(), TestSqliteDatabase::new());
}
